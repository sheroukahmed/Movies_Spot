...
class movieDetailesViewModel {
    ...
    var showErrorToViewController: ((String) -> ())?
    ...
    func loadDatafromCoreData() {
            CoreDataManager.shared.getMovie(completion: { [weak self] storedMovies in
                ...
                if !movieFound {
                    ...
                    self?.showErrorToViewController?("Movie not found in Core Data.")
                }
            })
        }
}
